        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Button size="lg" className="bg-navy-900 hover:bg-navy-800 text-white rounded-full h-14 px-8 shadow-lg shadow-navy-900/20 text-lg">
                Request Demo Class
              </Button>
              <Button asChild size="lg" variant="outline" className="border-navy-200 hover:bg-navy-50 text-navy-900 rounded-full h-14 px-8 text-lg flex items-center gap-2">
                <Link href="/login">
