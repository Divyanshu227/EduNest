...
import { Plus, Megaphone, Trash2, Pin, Calendar, X, Users } from 'lucide-react';
...
export function AdminAnnouncementsClient({ initialAnnouncements }: AdminAnnouncementsClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAnnouncements(prev => [
        {
          ...data.data,
          author: { name: 'Me', email: '' } // Mock visual author tag
        },
        ...prev
      ]);
      setIsFormOpen(false);
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between gap-2 mb-2">
                <Badge variant="secondary" className="text-[10px] flex items-center gap-1.5 uppercase">
                  <Users className="h-3 w-3" /> {ann.audience}
                </Badge>
        ...
        {isFormOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
            <motion.div
              ...
              className="relative w-full max-w-xl rounded-3xl border border-border/60 bg-background/95 p-6 shadow-2xl backdrop-blur"
            >
              <Button
                variant="ghost"
                size="icon"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="Mathematics">Mathematics Scope</option>
                      <option value="Languages">Languages Scope</option>
                    </select>
                  </div>
